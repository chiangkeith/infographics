  ...
  _createClass(FertilityD3, [{
    ...
    value: function init() {
      ...
      d3.json('./data/1980.json', function (rawdata) {
        ...
        var data = rawdata.children;
        _this.data = data;
        _this.bounds = _this.getBounds(data, 1);
        debug(data);
        ...
        d3.select('svg g.chart').selectAll('circle').data(data).enter().append('circle').attr('cx', function (d) {
          ...
          d3.select('svg g.chart #countryLabel').text(d.Country).transition().style('opacity', 1);

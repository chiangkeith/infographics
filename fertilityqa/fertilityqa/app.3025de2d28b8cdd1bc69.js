...
var _d = __webpack_require__(53);

var _comm = __webpack_require__(59);

var _kcScroll = __webpack_require__(28);

var _lodash = __webpack_require__(27);

var _jshashtable = __webpack_require__(102);

var _jshashtable2 = _interopRequireDefault(_jshashtable);

var _verge = __webpack_require__(26);

var _verge2 = _interopRequireDefault(_verge);

var _pym = __webpack_require__(103);
...
var chartList = [{ selector: '.ch2', id: 2 }, { selector: '.ch3', id: 3 }, { selector: '.ch4', id: 4 }, { selector: '.a2m08', id: 5 }, { selector: '.a2m13', id: 6 }, { selector: '.a3m15', id: 7 }, { selector: '.ch8', id: 8 }, { selector: '.a3t12-2', id: 9 }, { selector: '.a4m18-2', id: 10 }, { selector: '.a4m22', id: 11 }, { selector: '.a4t18', id: 12 }, { selector: '.a4t20', id: 13 }];

var debugRaw = __webpack_require__(3);
var debug = __webpack_require__(3)('FERTILITY:DEFAULT');
var debugScroll = __webpack_require__(3)('FERTILITY:SCROLL');
var debugLayoutDone = __webpack_require__(3)('FERTILITY:layoutDone');
var debugMobile = __webpack_require__(3)('FERTILITY:MOBILE');
var deviceHeight = void 0,
    deviceWidth = void 0;
var setUpClickHandler = function setUpClickHandler() {
  return new Promise(function (resolve) {
    var shareBtns = [].concat(_toConsumableArray(document.querySelectorAll('.nav--btnset > div')));
    var mmBtn = document.querySelector('.topbtn.mirrormedia');
    var navBtns = [].concat(_toConsumableArray(document.querySelectorAll('.marker--btn')));
    var continueBtn = document.querySelector('.continue.btn');
    (0, _lodash.map)(shareBtns, function (btn) {
      var className = btn.getAttribute('class').indexOf('facebook') > -1 ? 'fb' : btn.getAttribute('class').indexOf('line') > -1 ? 'line' : btn.getAttribute('class').indexOf('g-plus') > -1 ? 'gplus' : undefined;
      className && btn.addEventListener('click', function () {
        return (0, _comm.sendGa)({
          category: 'projects',
          action: 'click',
    ...
    (0, _lodash.map)(navBtns, function (btn, index) {
    ...
    mmBtn && mmBtn.addEventListener('click', function () {
      return (0, _comm.sendGa)({
        category: 'projects',
        action: 'click',
        label: 'back to home',
    ...
    continueBtn && continueBtn.addEventListener('click', function (e) {
...
var Fertility = function () {
  function Fertility() {
    _classCallCheck(this, Fertility);
  }

  _createClass(Fertility, [{
    key: 'init',
    value: function init() {
      var _this = this;
      ...
      this.device = (0, _comm.getClientOS)();
      this.scrollStep = this.device !== 'iOS' && this.device !== 'Android' ? 10 : 30;

      Promise.all([this.reviseOpts(), this.setupOpening(), setUpClickHandler()]).then(function () {
        (0, _comm.renderChart)(document.querySelector('article[data-key="1"] .hichart'), '1');
        (0, _comm.renderChart)(document.querySelector('article[data-key="81"] .hichart'), '81');
        (0, _comm.renderChart)(document.querySelector('article[data-key="11"] .hichart'), '11');
        (0, _comm.renderChart)(document.querySelector('article[data-key="811"] .hichart'), '811');
        (0, _comm.renderChart)(document.querySelector('article[data-key="141"] .hichart'), '141');
        (0, _comm.renderChart)(document.querySelector('article[data-key="14"] .hichart'), '14');
        (0, _comm.renderChart)(document.querySelector('article[data-key="814"] .hichart'), '814');
        (0, _comm.renderChart)(document.querySelector('article[data-key="16112"] .hichart'), '16112');
        (0, _comm.renderChart)(document.querySelector('article[data-key="816112"] .hichart'), '816112');
        (0, _comm.renderChart)(document.querySelector('article[data-key="16251"] .hichart'), '16251');
        (0, _comm.renderChart)(document.querySelector('article[data-key="816251"] .hichart'), '816251');
        (0, _comm.renderChart)(document.querySelector('article[data-key="131"] .hichart'), '131');
        (0, _comm.renderChart)(document.querySelector('article[data-key="8131"] .hichart'), '8131');
        (0, _comm.renderChart)(document.querySelector('article[data-key="23"] .hichart'), '23');
        (0, _comm.renderChart)(document.querySelector('article[data-key="823"] .hichart'), '823');
        (0, _comm.renderChart)(document.querySelector('article[data-key="16123"] .hichart'), '16123');
        (0, _comm.renderChart)(document.querySelector('article[data-key="816123"] .hichart'), '816123');
        return _this.suckBlocks().then(function () {
          return _this.removeBlocks().then(function () {
    ...
    key: 'reviseOpts',
    value: function reviseOpts() {
      return new Promise(function (resolve) {
        var options = [].concat(_toConsumableArray(document.querySelectorAll('.choices > li')));
    ...
    value: function removeBlocks() {
      ...
      return new Promise(function (resolve) {
        var blocks = [].concat(_toConsumableArray(document.querySelectorAll('article')));
        blocks.map(function (block) {
          _this2.playground.removeChild(block);
        });
        resolve();
      });
    }
    ...
    key: 'setupOpening',
    value: function setupOpening() {
      var _this3 = this;

      return new Promise(function (resolve) {
        var btnStart = document.querySelector('.opening .choices li');
        var btnClickHandler = function btnClickHandler() {
          _this3.playground.appendChild(_this3.blocks[0]);
          _this3.setupNextQAHandler(_this3.blocks[0], 0);
          btnStart.removeEventListener('click', btnClickHandler);
          var targetY = (0, _comm.elmYPosition)({ eID: 'article[data-key="0"]' });
          debug('about to go next qa', targetY);
          (0, _kcScroll.smoothScrollTo)({ yPos: targetY, steps: _this3.scrollStep });
        };
    ...
    key: 'suckBlocks',
    value: function suckBlocks() {
      var _this4 = this;

      return new Promise(function (resolve) {
        var blocks = [].concat(_toConsumableArray(document.querySelectorAll('article')));
        blocks.map(function (block) {
          _this4.blocks[block.getAttribute('data-key')] = block;
        });
        resolve();
      });
    }
  }, {
    key: 'setupNextQAHandler',
    value: function setupNextQAHandler(block, lastqNum) {
      var _this5 = this;

      return new Promise(function (resolve) {
        var btns = [].concat(_toConsumableArray(block.querySelectorAll('.choices > li')));
        var btnClickHandler = function btnClickHandler(e) {
          var thisBlock = block.getAttribute('data-key');
          var targKey = e.target.getAttribute('data-key');
          _this5.playground.appendChild(_this5.blocks[targKey]);
          _this5.setupNextQAHandler(_this5.blocks[targKey], thisBlock).then(function () {
            _this5.sendAnswer(lastqNum + '-' + thisBlock + '-' + targKey, targKey);
          });
          btns.map(function (btn) {
            btn.removeEventListener('click', btnClickHandler);
            (0, _comm.addClass)(btn, 'invalid');
          });
          (0, _comm.renderChart)(document.querySelector('article[data-key="' + targKey + '"] .hichart'), targKey);
          debug('about to go next qa');
          (0, _kcScroll.smoothScrollTo)({ yPos: (0, _comm.elmYPosition)({ eID: 'article[data-key="' + targKey + '"]' }), steps: _this5.scrollStep });
        };
        btns.map(function (btn) {
    ...
    key: 'sendAnswer',
    value: function sendAnswer(qcom, nextqNum) {
      var _this6 = this;
      ...
      xhttp.onreadystatechange = function () {
        if (xhttp.readyState === 4 && xhttp.status === 200) {
          ...
          var theSameRate = Math.round(Number(last_qa_result[qcom]) * 1000 / total_count) / 10 + '%';
          var next_feedback_place = _this6.blocks[nextqNum].querySelector('.feedback > .count');
          if (next_feedback_place) {
            _this6.blocks[nextqNum].querySelector('.feedback > .count').innerText = theSameRate;
          }
        }
      };
      var url = 'https://www.mirrormedia.mg/gorest/poll_increase?qid=stork01162&field=' + qcom;
...
var Article = function () {
  ...
  _createClass(Article, [{
    ...
    value: function init() {
      ...
      Promise.all([this.renderHichart(), this.setScrollManager(), setUpClickHandler()]).then(function () {
        debug('INIT FUNISHED');
    ...
    value: function preCalc() {
      ...
      return new Promise(function (resolve) {
        ...
        var articles = [].concat(_toConsumableArray(document.querySelectorAll('.articlewpr')));

        (0, _lodash.map)(articles, function (article, index) {
          var sects = [].concat(_toConsumableArray(article.querySelectorAll('section')));
        ...
        (0, _lodash.map)(domSects, function (sect, index) {
          var className = sect.getAttribute('class');
          if (!className) {
            return;
          }
          var height = sect.clientHeight;
          var top = (0, _comm.elmYPosition)({ ele: sect });
          var chart = sect.querySelector('.chart-container');
          // chart && chart.setAttribute('style', `width: ${chart.clientWidth}px;`)
          chart && _this8.setChartFixed(chart);

          _this8.hashSects.put('s' + index, {
            ele: sect, height: height,
            top: top, bottom: height + top,
            selector: '.' + className.split(' ').join('.'),
            chart: chart
          });
        });
        debug('this.hashSects');
        debug(_this8.hashSects.values());
        resolve();
      });
    }
  }, {
    key: 'setChartFixed',
    value: function setChartFixed(chart) {
      return new Promise(function (resolve) {
        (0, _comm.addClass)(chart, 'fix');
        resolve();
      });
    }
  }, {
    key: 'setupChartPos',
    value: function setupChartPos(chartContainer) {
      return new Promise(function (resolve) {
        var sourceSet = chartContainer.parentNode.querySelector('.source-set');
        debugScroll('chartContainer', chartContainer.clientWidth);
        debugScroll('chartContainer sibling', sourceSet);
        var flag = chartContainer.querySelector('.ratiowpr__chart') || false;
        var chart = flag || chartContainer.querySelector('.combo') || chartContainer.querySelector('.hichart');
        if (!chart) {
          return;
        }
        ...
        var top = 'top: calc(50% - ' + height / 2 + 'px);';
        var left = 'left: calc(50% - ' + width / 2 + 'px);';
        debug('width', width);
        if (flag) {
        ...
        if (sourceSet) {
          ...
          var align = sourceSet.getAttribute('textalign');
          var textAlign = align ? align === 'right' ? 'text-align: center;' : 'text-align: ' + align + ';' : '';
          var sourceHight = sourceSet.clientHeight;
          var sourceWidth = sourceSet.clientWidth;
          var sourceTop = 'top: calc(50% - ' + height / 2 + 'px - ' + (align ? 40 : 0) + 'px);';
          var sourceLeft = flag ? align !== 'right' ? left : 'left: 50%;' : '';
    ...
    key: 'setCoverout',
    value: function setCoverout(line) {
      return new Promise(function (resolve) {
        (0, _comm.addClass)(line, 'active');
        resolve();
      });
    }
  }, {
    key: 'setSectFadeIn',
    value: function setSectFadeIn(sect) {
      return new Promsie(function (resolve) {
        (0, _comm.removeClass)(sect, 'fadein');
        resolve();
      });
    }
  }, {
    ...
    value: function scrollHandlerForLongFix() {
      ...
      if (!this.longshowStart || !this.longshowEnd) {
        return;
      }
      ...
      var longshowStartTop = (0, _comm.elmYPosition)({ ele: this.longshowStart });
      var londshowEndTop = (0, _comm.elmYPosition)({ ele: this.longshowEnd });
      if (longshowStartTop <= curr && londshowEndTop + this.longshowEnd.clientHeight >= curr + deviceHeight) {
        (0, _comm.addClass)(this.longfix, 'keepshow');
      } else {
        (0, _comm.removeClass)(this.longfix, 'keepshow');
      }
    }
  }, {
    ...
    value: function scrollHandlerForFix(event) {
      ...
      var destroyFixup = function destroyFixup(container) {
        return new Promise(function (resolve) {
          container.removeAttribute('style');
          resolve();
        });
      };
      var goWithParent = function goWithParent(container) {
        return new Promise(function (resolve) {
          container.removeAttribute('style');
          var chartContainerWidth = container.clientWidth;
          var chartContainerHeight = container.clientHeight;
      ...
      if (currSect && currSect.ele.className && currSect.ele.className.indexOf('fix') > -1) {
        ...
        var chartContainer = currSect.ele.querySelector('.chart-container');
        var textContainer = currSect.ele.querySelector('.text-container');
        var ratiowpr = chartContainer.querySelector('.ratiowpr > div');
    ...
    value: function scrollHandler(event) {
      ...
      var sects = this.hashSects.values();
      var lastSect = document.querySelector('section.fadein');
      var currSect = (0, _lodash.find)(sects, function (sect) {
        return sect.top <= middle && sect.bottom >= middle;
      });
      ...
      if (currSect && lastSect !== currSect.ele) {
        if (currSect.chart) {
          this.setupChartPos(currSect.chart).then(function () {
            return fadein();
          });
          var chartReached = (0, _lodash.find)(chartList, function (chart) {
            return !chart.flag && document.querySelector('section ' + chart.selector) === currSect.chart;
          });
          chartReached && (0, _comm.sendGa)({
            category: 'projects',
            action: 'scroll',
      ...
      if (curr > 1) {
        var sourceSet = document.querySelector('.source-set');
        var exception = document.querySelector('.exception');
        if (sourceSet) {
          sourceSet.removeAttribute('style');
          exception.removeAttribute('style');
          var sourceHight = sourceSet.clientHeight;
          var sourceWidth = sourceSet.clientWidth;
          var sourcePos = (0, _comm.getPosition)(sourceSet);
          var sourceTop = 'top: ' + sourcePos.y + 'px;';
          var sourceLeft = '';
    ...
    key: 'fixSectChart',
    value: function fixSectChart(chart) {
      return new Promise(function (resolve) {
        (0, _comm.addClass)(chart, 'fix');
        resolve();
      });
...
var ArticleMobile = function (_Article) {
  _inherits(ArticleMobile, _Article);
  ...
  _createClass(ArticleMobile, [{
    ...
    value: function init() {
      ...
      Promise.all([this.preCalc(), this.renderHichart(), this.setupScrollManager(), setUpClickHandler()]).then(function () {
    ...
    value: function triggerAnimation() {
      ...
      var lastSect = document.querySelector('section.fadein');
      var currSect = (0, _lodash.find)(sects, function (sect) {
        var sectTop = (0, _comm.elmYPosition)({ ele: sect.ele });
        var sectBtm = sectTop + sect.ele.clientHeight;
        // debugRaw('FERTILITY:MOBILE:REVISE')(`${sect.height} >>`, `${sect.ele.clientHeight}`)
        // debugRaw('FERTILITY:MOBILE:REVISE')(`${sect.top} >>`, `${sectTop}`)
        // debugRaw('FERTILITY:MOBILE:REVISE')(`${sect.bottom} >>`, `${sectBtm}`)
      ...
      if (currSect && lastSect !== currSect.ele) {
        ...
        var chartReached = (0, _lodash.find)(chartList, function (chart) {
          return currSect.chart && !chart.flag && document.querySelector('section ' + chart.selector) === currSect.chart;
        });
        chartReached && (0, _comm.sendGa)({
          category: 'projects',
          action: 'scroll',
        ...
        var line = currSect.ele.querySelector('.ratiowpr__chart__img.line');
        if (line) {
          var lineTop = (0, _comm.elmYPosition)({ ele: line });
...
window.addEventListener('DOMContentLoaded', function () {
  var fertility = void 0;
  var pymChild = new _pym2.default.Child({ renderCallback: function renderCallback() {} });
  window.addEventListener('layoutDone', function () {
    window.localStorage.debug = 'FERTILITY:*,FERTILITY:SCROLL,COMM,d3';
    // window.localStorage.debug = 'COMM'
    deviceHeight = _verge2.default.viewportH();
    deviceWidth = _verge2.default.viewportW();
    /**
    ...
    if (location.href.indexOf('article') > -1) {
      var pymParent = new _pym2.default.Parent('mm-projects', 'https://mirrormedia.mg/project-list/dark?excluding=fertilityqa', {});
...
var debug = __webpack_require__(3)('d3');

var FertilityD3 = exports.FertilityD3 = function () {
  function FertilityD3() {
    _classCallCheck(this, FertilityD3);
  ...
  _createClass(FertilityD3, [{
    key: 'init',
    value: function init(eleSelector, year) {
      var _this = this;

      d3.json('./data/1980.json', function (rawdata) {
        _this.xAxis = 'rate1';
        _this.yAxis = 'rate2';
        _this.rawdata = rawdata;
        _this.data = year ? rawdata[year] : rawdata['1980'];
        _this.bounds = _this.getBounds(_lodash2.default.concat.apply(_lodash2.default, _toConsumableArray(_lodash2.default.map(rawdata, function (d) {
          return d;
        }))), 1);
        debug(_this.data);
        debug('bounds', _this.bounds);
        debug(_lodash2.default.concat.apply(_lodash2.default, _toConsumableArray(_lodash2.default.map(rawdata, function (d) {
          return d;
        }))));

        _this.svgWidth = document.querySelector(eleSelector).clientWidth || 1000;
        // this.scale = this.svgWidth / 1000
        // this.ratio = this.svgWidth < 1000 ? (740 / 828) : ( 640 / 1000)
        // this.svgHeight = this.svgWidth * this.ratio
        _this.svgHeight = document.querySelector(eleSelector).clientHeight || 640;
        _this.bias = _this.svgWidth < 1100 ? 300 : 130;
        // this.bias = 0
        ...
        d3.select(_this.eleSelector + ' svg g.chart').append('text').attr({ 'id': 'xLabel', 'x': _this.svgWidth / 2, 'y': _this.svgHeight + 50 - _this.bias / 2, 'text-anchor': 'middle' }).text('生育率');

        d3.select(_this.eleSelector + ' svg g.chart').append('text').attr('transform', 'translate(' + (_this.svgWidth > 500 ? -60 : -30) + ', ' + (_this.svgWidth > 500 ? _this.svgHeight / 3 + _this.bias / 2 : _this.bias) + ')rotate(-90)').attr({ 'id': 'yLabel', 'text-anchor': 'middle' }).text('女性勞参率');

        _this.updateScales();
        d3.select(_this.eleSelector + ' svg g.chart').selectAll('circle').data(_this.data).enter().append('circle').attr('cx', function (d) {
          return (isNaN(d[_this.xAxis]) ? d3.select(_this).attr('cx') : _this.xScale(d[_this.xAxis])) + (_this.svgWidth > 500 ? 0 : -50);
        }).attr('cy', function (d) {
          return (isNaN(d[_this.yAxis]) ? d3.select(_this).attr('cy') : _this.yScale(d[_this.yAxis])) + _this.bias / 2;
        }).attr('class', function (d) {
          var _class = d.class === 'L' ? 'low' : d.class === 'H' ? 'high' : 'avg';
          return _class;
        });
        d3.select(_this.eleSelector + ' svg g.chart').selectAll('text.name').data(_this.data).enter().append('text').attr('class', 'name').attr("x", function (d) {
          return (isNaN(d[_this.xAxis]) ? d3.select(_this).attr('cx') : _this.xScale(d[_this.xAxis])) + (_this.svgWidth > 500 ? 0 : -50);
        }).attr("y", function (d) {
          return (isNaN(d[_this.yAxis]) ? d3.select(_this).attr('cy') : _this.yScale(d[_this.yAxis])) + 20 + _this.bias / 2;
        }).text(function (d) {
          debug('d.name', d.name);
          return d.name;
        });
        ...
        d3.select(_this.eleSelector + ' svg g.chart').append("g").attr('transform', 'translate(' + (_this.svgWidth > 500 ? 0 : -50) + ', ' + (_this.svgHeight - _this.bias / 2 + 10) + ')').attr('id', 'xAxis').call(_this.makeXAxis);
        d3.select(_this.eleSelector + ' svg g.chart').append("g").attr('id', 'yAxis').attr('transform', 'translate(' + (_this.svgWidth > 500 ? -10 : -50) + ', ' + _this.bias / 2 + ')').call(_this.makeYAxis);

        debug('g size', d3.select(_this.eleSelector + ' svg g.chart').node().getBBox());
        var newSize = d3.select(_this.eleSelector + ' svg g.chart').node().getBBox();
        d3.select(_this.eleSelector + ' svg').attr("width", newSize.width + 10).attr("height", newSize.height + _this.bias / 2);
      });
    }
  }, {
    key: 'updateScales',
    value: function updateScales() {
      this.xScale = d3.scale.linear().domain([this.bounds[this.xAxis].min, this.bounds[this.xAxis].max]).range([0, this.svgWidth > 500 ? this.svgWidth - 320 : this.svgWidth - 40]);

      this.yScale = d3.scale.linear().domain([this.bounds[this.yAxis].min, this.bounds[this.yAxis].max]).range([this.svgHeight - this.bias, 0]);
    }
  }, {
    key: 'updateChart',
    value: function updateChart(init) {
      var _this2 = this;

      this.updateScales();
      d3.select(this.eleSelector + ' svg g.chart').selectAll('circle').transition().duration(500).ease('quad-out').attr('cx', function (d) {
        return (isNaN(d[_this2.xAxis]) ? d3.select(_this2).attr('cx') : _this2.xScale(d[_this2.xAxis])) + (_this2.svgWidth > 500 ? 0 : -50);
      }).attr('cy', function (d) {
        return (isNaN(d[_this2.yAxis]) ? d3.select(_this2).attr('cy') : _this2.yScale(d[_this2.yAxis])) + _this2.bias / 2;
      }).attr('r', function (d) {
        return isNaN(d[_this2.xAxis]) || isNaN(d[_this2.yAxis]) ? 0 : 12;
      });
      d3.select(this.eleSelector + ' svg g.chart').selectAll('text.name').transition().duration(500).ease('quad-out').attr("x", function (d) {
        return (isNaN(d[_this2.xAxis]) ? d3.select(_this2).attr('cx') : _this2.xScale(d[_this2.xAxis])) + (_this2.svgWidth > 500 ? 0 : -50);
      }).attr("y", function (d) {
        return (isNaN(d[_this2.yAxis]) ? d3.select(_this2).attr('cy') : _this2.yScale(d[_this2.yAxis])) + 20 + _this2.bias / 2;
      });

      d3.select('#xAxis').transition().call(this.makeXAxis);
      d3.select('#yAxis').transition().call(this.makeYAxis);

      var xArray = _lodash2.default.map(this.data, function (d) {
        return d[_this2.xAxis];
      });
      var yArray = _lodash2.default.map(this.data, function (d) {
        return d[_this2.yAxis];
      });
      ...
      d3.select('#bestfit').style('opacity', 0).attr({ 'x1': this.xScale(x1), 'y1': this.yScale(y1) + this.bias / 2, 'x2': this.xScale(x2), 'y2': this.yScale(y2) + this.bias / 2 }).transition().duration(1500).style('opacity', 1);
    }
  }, {
    key: 'getBounds',
    value: function getBounds(d, paddingFactor) {
      // Find min and maxes (for the scales)
      paddingFactor = typeof paddingFactor !== 'undefined' ? paddingFactor : 1;

      var keys = _lodash2.default.keys(d[0]),
          b = {};
      _lodash2.default.each(keys, function (k) {
        b[k] = {};
        _lodash2.default.each(d, function (d) {
          if (isNaN(d[k])) return;
          if (b[k].min === undefined || d[k] < b[k].min) b[k].min = d[k];
          if (b[k].max === undefined || d[k] > b[k].max) b[k].max = d[k];
        });
    ...
    key: 'makeXAxis',
    value: function makeXAxis(s) {
      s.call(d3.svg.axis().scale(this.xScale).orient("bottom"));
    }
  }, {
    key: 'makeYAxis',
    value: function makeYAxis(s) {
      s.call(d3.svg.axis().scale(this.yScale).orient("left"));
    }
  }, {
    key: 'getCorrelation',
    value: function getCorrelation(xArray, yArray) {
      function sum(m, v) {
        return m + v;
      }
      ...
      function filterNaN(m, v, i) {
        isNaN(v) ? null : m.push(i);return m;
      }

      // clean the data (because we know that some values are missing)
      var xNaN = _lodash2.default.reduce(xArray, filterNaN, []);
      var yNaN = _lodash2.default.reduce(yArray, filterNaN, []);
      var include = _lodash2.default.intersection(xNaN, yNaN);
      var fX = _lodash2.default.map(include, function (d) {
        return xArray[d];
      });
      var fY = _lodash2.default.map(include, function (d) {
        return yArray[d];
      });

      var sumX = _lodash2.default.reduce(fX, sum, 0);
      var sumY = _lodash2.default.reduce(fY, sum, 0);
      var sumX2 = _lodash2.default.reduce(fX, sumSquares, 0);
      var sumY2 = _lodash2.default.reduce(fY, sumSquares, 0);
      var sumXY = _lodash2.default.reduce(fX, function (m, v, i) {
        return m + v * fY[i];
      }, 0);
    ...
    key: 'update',
    value: function update(year) {
      var _this3 = this;

      this.data = this.rawdata[year];

      d3.select(this.eleSelector + ' svg g.chart').selectAll('circle').data(this.data).enter().append('circle').attr('cx', function (d) {
        return (isNaN(d[_this3.xAxis]) ? d3.select(_this3).attr('cx') : _this3.xScale(d[_this3.xAxis])) + (_this3.svgWidth > 500 ? 0 : -50);
      }).attr('cy', function (d) {
        return (isNaN(d[_this3.yAxis]) ? d3.select(_this3).attr('cy') : _this3.yScale(d[_this3.yAxis])) + _this3.bias / 2;
      }).attr('class', function (d) {
        var _class = d.class === 'L' ? 'low' : d.class === 'H' ? 'high' : 'avg';
        return _class;
      });
      ...
      d3.select(this.eleSelector + ' svg g.chart').selectAll('text.name').data(this.data).attr("x", function (d) {
        return (isNaN(d[_this3.xAxis]) ? d3.select(_this3).attr('cx') : _this3.xScale(d[_this3.xAxis])) + (_this3.svgWidth > 500 ? 0 : -50);
      }).attr("y", function (d) {
        return isNaN(d[_this3.yAxis]) ? d3.select(_this3).attr('cy') : _this3.yScale(d[_this3.yAxis]) + 20 + _this3.bias / 2;
      }).text(function (d) {
        return d.name;
      });

      d3.select(this.eleSelector + ' svg g.chart').selectAll('text.name').data(this.data).enter().append('text').attr('class', 'name').attr("x", function (d) {
        return (isNaN(d[_this3.xAxis]) ? d3.select(_this3).attr('cx') : _this3.xScale(d[_this3.xAxis])) + (_this3.svgWidth > 500 ? 0 : -50);
      }).attr("y", function (d) {
        return isNaN(d[_this3.yAxis]) ? d3.select(_this3).attr('cy') : _this3.yScale(d[_this3.yAxis]) + 20 + _this3.bias / 2;
      }).text(function (d) {
      ...
      var circle = d3.select(this.eleSelector + ' svg g.chart').selectAll("circle").data(this.data);
      var names = d3.select(this.eleSelector + ' svg g.chart').selectAll('text.name').data(this.data);
      circle.exit().remove();
      names.exit().remove();
...
exports.getClientOS = getClientOS;
...
var config = _interopRequireWildcard(_hichart);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var debug = __webpack_require__(3)('COMM');
var THIS_PATH = document.location.href;
...
function renderChart(ele, targKey) {
  var configKey = '';
  switch (targKey) {
    case '1':
    case '81':
...
function elmYPosition(_ref) {
  var ele = _ref.ele,
      eID = _ref.eID,
      errHandler = _ref.errHandler;

  var elm = ele ? ele : document.querySelector(eID);
  if (!elm) {
...
function sendGa(_ref3) {
  ...
  debug('Just send ga event:', { category: category, action: action, label: label, noninteraction: noninteraction });
}
...
var T12 = exports.T12 = {
    ...
    xAxis: {
        categories: ['24-45歲勞參率', '24-45歲有6歲以下子女勞參率'],
        crosshair: false
    },
    yAxis: {
        min: 0,
...
var M15_REAL = exports.M15_REAL = {
    ...
    series: [{
        ...
        data: [{ x: 1.2, y: 43.4, name: "葡萄牙" }, { x: 1.5, y: 41.0, name: "瑞士" }, { x: 1.3, y: 36.0, name: "西班牙" }, { x: 1.2, y: 34.3, name: "韓國" }, { x: 1.4, y: 29.4, name: "日本" }, { x: 1.4, y: 29.3, name: "德國" }, { x: 1.5, y: 23.3, name: "拉脫維亞" }, { x: 1.4, y: 23.1, name: "以色列" }, { x: 1.5, y: 22.8, name: "愛沙尼亞" }, { x: 1.4, y: 19.3, name: "奧地利" }, { x: 1.3, y: 16.9, name: "希臘" }, { x: 1.3, y: 14.2, name: "匈牙利" }, { x: 1.07, y: 9.83, name: "台灣" }, { x: 1.3, y: 9.3, name: "波蘭" }, { x: 1.5, y: 4.3, name: "捷克" }, { x: 1.3, y: 3.1, name: "斯洛伐克" }]
    }, {
        type: 'scatter',
        name: '生育率高於 1.5',
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.trim=trim,exports.addClass=addClass,exports.hasClass=hasClass,exports.removeClass=removeClass,exports.getClientOS=getClientOS;function trim(a){return a.replace(/^\s\s*/,'').replace(/\s\s*$/,'')}function addClass(a,b){hasClass(a,b)||(a.className+=' '+b),a.className=trim(a.className)}function hasClass(a,b){return a.className?a.className.match(new RegExp('(\\s|^)'+b+'(\\s|$)')):a.className=b}function removeClass(a,b){if(hasClass(a,b)){var c=new RegExp('(\\s|^)'+b+'(\\s|$)');a.className=a.className.replace(c,' ')}a.className=trim(a.className)}function getClientOS(){var a=window.navigator.userAgent,b=window.navigator.platform,f=null;return-1===['Macintosh','MacIntel','MacPPC','Mac68K'].indexOf(b)?-1===['iPhone','iPad','iPod'].indexOf(b)?-1===['Win32','Win64','Windows','WinCE'].indexOf(b)?/Android/.test(a)?f='Android':!f&&/Linux/.test(b)&&(f='Linux'):f='Windows':f='iOS':f='Mac OS',f}var isSafari=exports.isSafari=function(){return!!navigator&&!!navigator.userAgent.match(/Version\/[\d\.]+.*Safari/)};
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! pym.js - v1.3.1 - 2017-07-25 */
/*

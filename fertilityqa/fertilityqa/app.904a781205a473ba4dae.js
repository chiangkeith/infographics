...
var Article = function () {
  ...
  _createClass(Article, [{
    ...
    value: function init() {
      ...
      (0, _comm.renderChart)(document.querySelector('.chart-container.a3m15 .hichart'), 'm15');
    ...
    value: function setupChartPos(chartContainer) {
      return new Promise(function (resolve) {
        debugScroll('chartContainer', chartContainer);
        chartContainer.setAttribute('style', 'width: ' + chartContainer.clientWidth + 'px;');
        var chart = chartContainer.querySelector('.ratiowpr__chart') || chartContainer.querySelector('.hichart');
        if (!chart) {
          return;
        }
        var height = chart.clientHeight;
        var width = chart.clientWidth;
        chart.setAttribute('style', 'top: 50%; left: 50%; margin-top: -' + height / 2 + 'px; margin-left: -' + width / 2 + 'px;');
        resolve();
      });
    }
  }, {
    ...
    value: function scrollHandler(event) {
      ...
      if (lastSect !== currSect.ele) {
        if (currSect.chart) {
          this.setupChartPos(currSect.chart).then(function () {
            return currSect.ele && (0, _comm.addClass)(currSect.ele, 'fadein');
          });
        } else {
    ...
    value: function setScrollManager() {
      ...
      return new Promise(function (resolve) {
        window.addEventListener('scroll', _this8.scrollHandler);
        resolve();
      });
    }
  }, {
    ...
    value: function resetScrollManager() {
      ...
      return Promise.all([new Promise(function (resolve) {
        windoe.removeEventListener('scroll', _this9.scrollHandler);
        resolve();

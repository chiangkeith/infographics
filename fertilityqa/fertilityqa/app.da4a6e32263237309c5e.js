...
var Article = function () {
  ...
  _createClass(Article, [{
    ...
    value: function init() {
      debug('INIT ARTICLE');
      (0, _comm.renderChart)(document.querySelector('section[class="s1"] .hichart'), '1');
    ...
    value: function preCalc() {
      ...
      return new Promise(function (resolve) {
        ...
        // /**
        //  * fetch all articles heigh and set it to inline style
        //  */
        articles.map(function (article, index) {
          ...
          // const top = elmYPosition({ ele: article })
          // debug(`article-${index}'s height`, height)
          // this.hashArticles.put(`a${index}`, { height, top })
          // debug(`write it to hashArticles`)
        });
        // debug('Got article hash:')
        // debug(this.hashArticles.values())
        ...
        domSects.map(function (sect, index) {
          ...
          _this7.hashSects.put('s' + index, {
            ...
            selector: '.' + sect.getAttribute('class').split(' ').join('.'),
            chart: chart
          });
        });

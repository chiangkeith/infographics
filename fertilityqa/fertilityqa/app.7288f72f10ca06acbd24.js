...
var Fertility = function () {
  ...
  _createClass(Fertility, [{
    ...
    value: function init() {
      ...
      Promise.all([this.reviseOpts(), this.setupOpening()]).then(function () {
    ...
    value: function setupOpening() {
      ...
      return new Promise(function (resolve) {
        ...
        var btnClickHandler = function btnClickHandler() {
          ...
          var targetY = (0, _comm.elmYPosition)('article[data-key="0"]');
    ...
    value: function setupNextQAHandler(block, lastqNum) {
      ...
      return new Promise(function (resolve) {
        ...
        var btnClickHandler = function btnClickHandler(e) {
          ...
          (0, _kcScroll.smoothScrollTo)({ yPos: (0, _comm.elmYPosition)('article[data-key="' + targKey + '"]'), steps: _this5.scrollStep });
        };
        btns.map(function (btn) {

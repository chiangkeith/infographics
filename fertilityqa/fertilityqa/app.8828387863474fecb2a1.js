...
var _kcScroll = __webpack_require__(27);

var _lodash = __webpack_require__(98);

var _jshashtable = __webpack_require__(101);
...
var debug = __webpack_require__(14)('FERTILITY:DEFAULT');
var debugScroll = __webpack_require__(14)('FERTILITY:SCROLL');
...
var Article = function () {
  ...
  _createClass(Article, [{
    ...
    value: function init() {
      debug('INIT ARTICLE');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a1m01 .hichart'), '1');
      // renderChart(document.querySelector(`.a1m18 .hichart`), '11')
      (0, _comm.renderChart)(document.querySelector('.chart-container.a1m18 .hichart'), 'm18');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a2m18 .hichart'), '11');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a2m18-2 .hichart'), '11');
      // renderChart(document.querySelector(`.chart-container.a2m13 .hichart`), '11')
      (0, _comm.renderChart)(document.querySelector('.chart-container.a2m14 .hichart'), 'm14');
      // renderChart(document.querySelector(`.chart-container.a3m15 .hichart`), 'm15')
      (0, _comm.renderChart)(document.querySelector('.chart-container.a3t12 .hichart'), 't12');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a3m18 .hichart'), 'm18');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a4m22 .hichart'), 'm22');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a4m25 .hichart'), 'm25');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a4m28 .hichart'), 'm28');
      ...
      (0, _comm.renderChart)(document.querySelector('.chart-container.a4t15 .hichart'), 't15');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a4t18 .hichart'), 't18');
      (0, _comm.renderChart)(document.querySelector('.chart-container.a4t20 .hichart'), 't20');
      ...
      Promise.all([this.preCalc(), this.setScrollManager()]).then(function () {
        debug('INIT FUNISHED');
      });
    }
  }, {
    ...
    value: function preCalc() {
      ...
      return new Promise(function (resolve) {
        ...
        domSects.map(function (sect, index) {
          ...
          chart && _this7.setChartFixed(chart);

          _this7.hashSects.put('s' + index, {
    ...
    value: function setupChartPos(chartContainer) {
      return new Promise(function (resolve) {
        ...
        var chart = flag || chartContainer.querySelector('.hichart');
        if (!chart) {
          return;
        }
        ...
        if (flag) {
          chart.setAttribute('style', '' + top + left + ' width: ' + width + 'px; height: ' + height + 'px;z-index: 1;');
        } else {
          chart.setAttribute('style', top + ' width: ' + width + 'px; height: ' + height + 'px;z-index: 1;');
        }
        if (sourceSet) {
          ...
          var sourceTop = 'top: calc(50% - ' + height / 2 + 'px);';
          var sourceLeft = left;
          sourceSet.setAttribute('style', '' + sourceTop + sourceLeft + 'width: ' + sourceWidth + 'px; height: ' + sourceHight + 'px;position: fixed;z-index: 2;');
        }
        resolve();
      });
    }
    ...
    value: function setScrollManager() {
      ...
      return new Promise(function (resolve) {
        window.addEventListener('scroll', _this9.scrollHandler);
        resolve();
      });
    }
  }, {
    ...
    value: function resetScrollManager() {
      ...
      return Promise.all([new Promise(function (resolve) {
        windoe.removeEventListener('scroll', _this10.scrollHandler);
        resolve();
...
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('layoutDone', function () {
    ...
    debug(location.href);
    var fertility = location.href.indexOf('article') === -1 ? new Fertility() : new Article();
    fertility.init();
  });
});
...
throw new Error("Module build failed: ModuleBuildError: Module build failed: Error: /Library/WebServer/Documents/dev_keith/infographics/fertilityqa/src/index.styl:38:38\n   34|           align-items center\n   35|           _width 1000px\n   36|           &__img__container\n   37|             width _width\n   38|             height _width * (945/1601)\n--------------------------------------------^\n   39|             position relative        \n   40|           &__img\n   41|             position absolute\n\ncannot perform _width * (0.5902560899437851)\n    at \"&__img__container\" (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/src/index.styl:36:24)\n    at \"&__chart\" (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/src/index.styl:28:20)\n    at \".ratiowpr\" (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/src/index.styl:26:21)\n    at \".chart-container\" (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/src/index.styl:25:22)\n    at \"section\" (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/src/index.styl:19:22)\n    at \".articlewpr\" (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/src/index.styl:12:29)\n\n    at Ident.operate (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/nodes/node.js:234:15)\n    at Ident.operate (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/nodes/ident.js:155:33)\n    at CachedPathEvaluator.Evaluator.visitBinOp (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:581:28)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitExpression (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:644:26)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitExpression (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:644:26)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitProperty (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:687:22)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitBlock (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:720:39)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitGroup (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:261:22)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitBlock (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:720:39)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitGroup (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:261:22)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitBlock (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:720:39)\n    at CachedPathEvaluator.Visitor.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/index.js:28:40)\n    at CachedPathEvaluator.Evaluator.visit (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:160:18)\n    at CachedPathEvaluator.Evaluator.visitGroup (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/visitor/evaluator.js:261:22)\n    at runLoaders (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/webpack/lib/NormalModule.js:195:19)\n    at /Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/loader-runner/lib/LoaderRunner.js:364:11\n    at /Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/loader-runner/lib/LoaderRunner.js:230:18\n    at context.callback (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/loader-runner/lib/LoaderRunner.js:111:13)\n    at /Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus-loader/index.js:167:11\n    at Renderer.render (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus/lib/renderer.js:107:12)\n    at /Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/stylus-loader/index.js:165:12\n    at tryCatchReject (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/when/lib/makePromise.js:840:30)\n    at runContinuation1 (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/when/lib/makePromise.js:799:4)\n    at Fulfilled.when (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/when/lib/makePromise.js:590:4)\n    at Pending.run (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/when/lib/makePromise.js:481:13)\n    at Scheduler._drain (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/when/lib/Scheduler.js:62:19)\n    at Scheduler.drain (/Library/WebServer/Documents/dev_keith/infographics/fertilityqa/node_modules/when/lib/Scheduler.js:27:9)\n    at _combinedTickCallback (internal/process/next_tick.js:67:7)\n    at process._tickCallback (internal/process/next_tick.js:98:9)");
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(99), __webpack_require__(100)(module)))
